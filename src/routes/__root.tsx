...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "L&A Sweet creates handcrafted trompe-l'œil desserts in Brisbane. Two signature flavours, wholesale and private events." },
      { name: "author", content: "L&A Sweet" },
      { property: "og:title", content: "L&A Sweet — Handcrafted Trompe-l'œil Desserts, Brisbane" },
      { property: "og:description", content: "L&A Sweet creates handcrafted trompe-l'œil desserts in Brisbane. Two signature flavours, wholesale and private events." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "L&A Sweet — Handcrafted Trompe-l'œil Desserts, Brisbane" },
      { name: "twitter:description", content: "L&A Sweet creates handcrafted trompe-l'œil desserts in Brisbane. Two signature flavours, wholesale and private events." },
